...
//                WindowManager.LayoutParams.TYPE_PHONE,
        ...
        closeButtonCollapsed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //close the service and remove the from the window
                stopSelf();
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(FloatingViewService.this, "Playing the next song", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        prevButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(FloatingViewService.this, "Playing the previous song", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (Xdiff < 10 && Ydiff < 10) {
                            if (isCollapsed()) {
                                ...
                                //and expand view will become visible
